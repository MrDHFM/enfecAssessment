  ...
  return (
    <footer className="footer">
      <div className="footer-heading-container">
        ...
        discover <span className="symbol"><img src="https://www.trulia.com/images/icons/txl3/LocationLincolnIcon.svg" alt="location" /></span> a Place <span className="symbol"><img src="https://www.trulia.com/images/icons/txl3/TownHouseIcon.svg" alt="home"/></span> You'll Love&nbsp;<span className="symbol"><FaHeart style={{ color:"red" }} /></span> &nbsp;to Live
      ...
      <div className="footer-columns">
        <div className="footer-column">
          ...
          <ul className="footer-links">
            <li><a href="#alaska">Alaska Real Estate</a></li>
            <li><a href="#alabama">Alabama Real Estate</a></li>
            <li><a href="#arkansas">Arkansas Real Estate</a></li>
            <li><a href="#arizona">Arizona Real Estate
            </a></li>
        ...
        <div className="footer-column">
          ...
          <ul className="footer-links">
            <li><a href="#alaska">Land for Sale Near Me</a></li>
            <li><a href="#alabama">Open Houses Near Me</a></li>
            <li><a href="#arkansas">Townhomes for Rent Near Me</a></li>
            <li><a href="#arizona">Apartments for Rent Near Me</a></li>
            <li><a className='more' href="#">More<span className="symbol">↓</span></a></li>
        ...
        <div className="footer-column">
          ...
          <ul className="footer-links">
            <li><a href="#alaska">Facebook</a></li>
            <li><a href="#alabama">Twitter</a></li>
            <li><a href="#arkansas">Instagram</a></li>
            <li><a href="#arizona">Pinterest</a></li>
            <li><a className='more' href="#">More<span className="symbol">↓</span></a></li>
        ...
        <div className="footer-column">
          ...
          <ul className="footer-links">
            <li><a href="#alaska">Popular Counties</a></li>
            <li><a href="#alabama">Rental Communities</a></li>
            <li><a className='more' href="#arizona">Real Estate Leads</a></li>
          </ul>
        </div>
      </div>

      <div className="footer-info">
        <span>Trulia is a registered Trademark of Zillow, Inc. Zillow, Inc. holds real estate brokerage licenses in all 50 states and D.C. and Zillow (Canada) Inc. holds real estate brokerage <a href='#'  >licenses</a> in multiple provinces.<br /></span>
        <a href='#'>§ 442-H New York Standard Operating Procedures</a><br />
        <a href='#'>New York Fair Housing Notice</a> <br />
        <span style={{ textDecoration:"underline" , fontWeight: "100" }}>TREC:</span> <a href='#'>Information about brokerage services</a>, <a href='#'>Consumer protection notice</a><br />
        California DRE #1522444 <br />
        <span><a href="#">Contact Zillow, Inc Brokerage</a></span>
      </div>
      ...
      <div className="footer-brands">
        ...
        <ul className="footer-brand-list">
          ...
          <li><span>Do Not Sell or Share My Personal Information {">"}</span></li>
        </ul>
      </div>

      <div className="footer-accessibility">
        <p>Zillow Group is committed to ensuring digital accessibility for individuals with disabilities. We are continuously working to improve the accessibility of our web experience for everyone, and we welcome feedback and accommodation requests. If you wish to report an issue or seek an accommodation, please <span><a href='#'>let us know.</a></span></p>
      </div>

      <div className="footer-copyright">
        <p>Copyright © 2024 Trulia, LLC. All rights reserved.<a href='#'> Equal Housing Opportunity.</a> Have a Question? Visit our <a href='#'>Help Center</a> to find the answer.</p>
      </div>
